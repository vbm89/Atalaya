...
/**
 * Cutover guard. Pre-cutover freezes have no entryGates photograph.
 * Do not invent gates or postEntry for those episodes.
 */
export function hasEntryGatesPhoto(freeze: { entryGates?: unknown } | null | undefined): boolean {
  return freeze != null && freeze.entryGates != null && typeof freeze.entryGates === "object";
}
